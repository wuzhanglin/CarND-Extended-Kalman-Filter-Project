...
KalmanFilter FusionEKF::GetKalmanFilter() const
{
    return ekf_;
}
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack)
{
    ...
    const double dt_3_2_noise_ax = dt_3_2 * noise_ax;
    const double dt_3_2_noise_ay = dt_3_2 * noise_ay;
    
    ekf_.Q_ = MatrixXd(4, 4);
    ekf_.Q_ << dt_4_4 * noise_ax,   0,                  dt_3_2_noise_ax,    0,
               0,                   dt_4_4 * noise_ay,  0,                  dt_3_2_noise_ay,
               dt_3_2_noise_ax,     0,                  dt_2 * noise_ax,    0,
               0,                   dt_3_2_noise_ay,    0,                  dt_2 * noise_ay;
    ...
    cout << endl << "x: " << endl << ekf_.x_ << endl;
    cout << endl << "P: " << endl << ekf_.P_ << endl;
}
